...
func (r *repositories) FindUsers() ([]models.User, error) {
	...
	err := r.db.Preload("Transaction.Property").Preload("Transaction.User").Preload("Booking.Property").Preload("Booking.User").Find(&Users).Error
...
func (r *repositories) GetUser(ID int) (models.User, error) {
	...
	err := r.db.Preload("Transaction.Property").Preload("Transaction.User").Preload("Booking.Property").Preload("Booking.User").First(&User, ID).Error
